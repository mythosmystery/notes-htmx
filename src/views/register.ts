...
export const Register = () => {
  return html`
    <div
      class="mb-12 mt-6 bg-gradient-to-br from-blue-400 to-pink-400 bg-clip-text py-2 text-center text-3xl font-bold text-transparent"
    >
      Create an account
    </div>
    ...
    >
      ...
      <p class="text-sm text-slate-500">
        ...
        <a href="/login" class="text-blue-400 hover:text-purple-500">Login</a>
      </p>
